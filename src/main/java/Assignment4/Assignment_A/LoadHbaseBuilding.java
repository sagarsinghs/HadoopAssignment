...
import Assignment3.BuildingModel;
...
public class LoadHbaseBuilding {
    ...
    //public  static  String dir="/Users/sagarsangam/Documents/inputDirs/Buildings/buildingDetails1.csv";
     public  static  String dir="hdfs://localhost:9000/Users/sagarsangam/Downloads/Buildings/";
    ...
    public static void insertingDetails() throws IOException {
        ...
        try{
            ...
            if( admin.tableExists(TableName.valueOf("building")) ){
                ...
                table = connection.getTable(TableName.valueOf("building"));
            }else{
                ...
                HTableDescriptor tableDescriptor = new HTableDescriptor(TableName.valueOf("building"));

                // Adding column families to table descriptor
                //Name, age, company, building_code, phone_number, address
                tableDescriptor.addFamily(new HColumnDescriptor("Buildings"));
                tableDescriptor.addFamily(new HColumnDescriptor("address"));
                tableDescriptor.addFamily(new HColumnDescriptor("floor"));
                tableDescriptor.addFamily(new HColumnDescriptor("companyInBuilding"));
                tableDescriptor.addFamily(new HColumnDescriptor("cafeteriaCode"));
            ...
            for(Path path : filePaths){
                ...
                while(line !=null){
                    ...
                    p.addColumn(Bytes.toBytes("Buildings"), Bytes.toBytes("address"), Bytes.toBytes(fields[0]));
                    p.addColumn(Bytes.toBytes("Buildings"), Bytes.toBytes("floor"), Bytes.toBytes(fields[1]));
                    p.addColumn(Bytes.toBytes("Buildings"), Bytes.toBytes("companyInBuilding"), Bytes.toBytes(fields[2]));
                    p.addColumn(Bytes.toBytes("Buildings"), Bytes.toBytes("cafeteriaCode"), Bytes.toBytes(fields[3]));
                    table.put(p);
